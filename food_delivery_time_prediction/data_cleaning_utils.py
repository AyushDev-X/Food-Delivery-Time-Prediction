...
def perform_data_cleaning(
    data: pd.DataFrame,
    saved_data_path="/Users/ayushdx1905/Developer/ML_CODE/food-delivery-time-prediction/data/processed/swiggy_cleaned.csv",
):
...
if __name__ == "__main__":
    # data path for data
    DATA_PATH = "/Users/ayushdx1905/Developer/ML_CODE/food-delivery-time-prediction/data/raw/swiggy.csv"
